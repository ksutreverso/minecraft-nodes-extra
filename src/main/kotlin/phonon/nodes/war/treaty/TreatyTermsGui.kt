...
// middle bar, 4 down
val guiMiddleBar4 = GuiElementList(
    listOf(
...
// middle bar, 5 down
val guiMiddleBar5 = GuiElementList(
    listOf(
        GuiFillColor(4, 0, GuiColor.BLACK),
        GuiFillColor(4, 1, GuiColor.BLACK),
        GuiFillColor(4, 2, GuiColor.BLACK),
...
val otherSideFillBottomGray = GuiElementList(
    listOf(
...
val otherSideFillBottomGreen = GuiElementList(
    listOf(
...
public class TreatyTermsGui(
    ...
    val guiButtonConfirm = GuiButton(
        4,
        5,
        ICON_CONFIRM,
        null,
